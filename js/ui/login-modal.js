    ...
    function render() {
        ...
        if (mode === "login") {
            ...
            fields = `
                ...
                <input id="lf-phone" type="tel" placeholder="PHONE NUMBER" autocomplete="tel" style="${fieldStyle()}" />
                <input id="lf-username" type="text" placeholder="CHOOSE A USERNAME" autocomplete="username" style="${fieldStyle()}" />
            ...
            fields = `
                ...
                <input id="lf-username" type="text" placeholder="USERNAME" autocomplete="username" style="${fieldStyle()}" />
                <input id="lf-phone" type="tel" placeholder="PHONE NUMBER ON YOUR ACCOUNT" autocomplete="tel" style="${fieldStyle()}" />
...
export function renderForceChangePasswordModal(onSuccess, onLogout) {
    ...
    overlay.innerHTML = `
        <div class="modal-content" style="border: 2px solid var(--color-accent); background: var(--color-surface); color: var(--color-text); padding: 30px; width: 320px; font-family: 'Courier New', monospace;">
            ...
            <input id="fcp-current" type="password" placeholder="TEMPORARY PASSWORD" autocomplete="current-password" style="${fieldStyle()}" />
            <input id="fcp-new" type="password" placeholder="NEW PASSWORD" autocomplete="new-password" style="${fieldStyle()}" />
