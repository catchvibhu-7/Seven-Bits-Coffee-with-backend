...
export const SimonGame = {
    ...
    render(message = "") {
        this.root.innerHTML = `
            ...
            <p style="text-align:center; font-size:9pt; color:var(--color-text-muted); margin-bottom:8px;">ROUND: <strong id="simon-round" style="color:var(--color-accent);">${this.sequence.length}</strong></p>
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px; max-width:220px; margin:0 auto;">
            ...
            <p id="simon-message" style="text-align:center; font-size:1.05rem; color:var(--color-danger); margin:14px 0 0; min-height:1.4em;">${message}</p>
